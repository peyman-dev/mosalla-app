...
const Footer = () => {
    return <footer className=" pt-24 bg-[#F9EDCE] relative mt-25.5">
        ...
        <div className="relative size-full">
            <h6 className="text-center text-2xl font-bold flex-center gap-3">
                همین حالا ثبت نام کن و در افطاری
                <span className="font-IranNastaliq font-normal! text-primary text-[64px]">
                    ماه مبارک رمضان
                </span>
            ...
            <div className="flex-center mt-8">
                <Link className="bg-primary-green text-2xl font-bold!  py-2.5 px-3.75 text-white rounded-[10px]" href="#">
                    ثبت نام در افطاری
                </Link>
            </div>
        ...
        <Image
            ...
            className="absolute left-[254px] top-0"
        />

        <div className="relative -bottom-0 mt-10 right-0 left-0 w-full mx-auto h-[69px] bg-repeat-x bg-[url('/images/icons/footer-shape.png')]"></div>
    </footer>;
};
